...
describe(`"it" chains`, () => {
	...
	test("isnum (trailing nilad)", () => expect(it.isnum(123)).toBe(true))
	test("square using mul(it)", () => expect(mul(it)(3)).toBe(9))
	test("str len (trailing nilad)", () => expect(str.len("arstneio")).toBe(8))
	...
	test("t flag", () => {
		...
		expect(s).toEqual(S([104, 101, 108, 111, 32, 119, 114, 100]))
	})
